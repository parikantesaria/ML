...
def predict_default(payload: LoanPredictionRequest):
    # Rule-based / scoring algorithm mirroring logistic regression behavior
    base_score = 0.50
    
    # Credit Score factor (-0.35 to +0.35)
    credit_factor = (700 - payload.CreditScore) / 400.0 * 0.35
    
    # DTI Ratio factor (0.0 to 0.30)
    ...
    # Calculate raw probability bounded between 0.01 and 0.99
